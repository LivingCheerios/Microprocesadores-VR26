...
Para poder realizar el ejercicio 2 se utilizó una lógica similar:

* Se inicializa el puerto D completo como salida declarando TRISD = 0x00;. A estos pines estarán conectados los segmentos (a, b, c, d, e, f, g) del display.

* Se declara un arreglo (array) llamado hex que contiene los valores hexadecimales precalculados para formar los números, como se hizo anteriormente.

* De nueva menara, se declara una variable unsigned char i = 0;. Esta variable tiene un doble propósito: llevará el control numérico de nuestra cuenta y, al mismo tiempo, funcionará como el "índice" para saber qué posición del arreglo hex debemos leer.
...
* Si la variable i llega al número 16, la condición se cumple y se ejecuta i = 0; para reiniciar el índice al principio de la lista.
